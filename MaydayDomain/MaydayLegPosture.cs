...
{
    public static MaydayLegPosture FromRevolutions(double coxaAngle, double femurAngle, double tibiaAngle)
    {
        return new(
            Angle.FromRevolutions(coxaAngle),
            Angle.FromRevolutions(femurAngle),
            Angle.FromRevolutions(tibiaAngle));
    }

    public MaydayLegPosture(IEnumerable<Angle> angles)
        : this(angles.Skip(0).First(), angles.Skip(1).First(), angles.Skip(2).First()) {}
    
    public static MaydayLegPosture Neutral => FromRevolutions(0.0, 0.0, 0.0);
    public static MaydayLegPosture NeutralWithStraightFemur => FromRevolutions(0.0, 0.0625, 0.0);
    public static MaydayLegPosture NeutralWithBackTwist => FromRevolutions(0.125, 0.0, 00.0);
    public static MaydayLegPosture Straight => FromRevolutions(0.0, 0.0625, 0.25-0.0625);
    public static MaydayLegPosture StraightWithBackTwist => FromRevolutions(0.125, 0.0625, 0.25-0.0625);
    public static MaydayLegPosture Sitting => FromRevolutions(0.0, -0.3, -0.2);
